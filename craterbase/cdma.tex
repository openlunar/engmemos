...
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) (craters) {\includegraphics[width=\textwidth]{Gagarin_crater_AS17-M-1565_corner.jpg}};
    ...
    \node[align=left] at (13.8,4.6) (features) { features };
    \node[My Arrow Style] at (15.7, 4.2) (matching) {feature \\ matching};
